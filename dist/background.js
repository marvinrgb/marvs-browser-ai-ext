...
function setupContextMenu() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        chrome.contextMenus.removeAll(() => __awaiter(this, void 0, void 0, function* () {
            ...
            const { categorySettings } = yield chrome.storage.sync.get('categorySettings');
...
chrome.contextMenus.onClicked.addListener((info, tab) => {
    ...
    if (info.menuItemId in prompts) {
        const prompt = promptBuilder(info.menuItemId, info.selectionText || "");
        callGeminiAPI(prompt, tab.id);
    }
});
// Main function to call the Gemini API
function callGeminiAPI(prompt, tabId) {
    return __awaiter(this, void 0, void 0, function* () {
        // 1. Get the API key from storage
        const { apiKey } = yield chrome.storage.sync.get('apiKey');
        if (!apiKey) {
...
function promptBuilder(task, content) {
    if (!content)
